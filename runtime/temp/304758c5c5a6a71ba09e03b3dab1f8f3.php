<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\phpstudy_pro\WWW\www.tp5.com/application/admin\view\logs\liveupdatelogslist.html";i:1702343545;}*/ ?>
...
//                });
        ...
        function simpleLoad(btn, state) {
            if (state) {
                ...
                location.href = "<?php echo url('liveUpdateLogsList'); ?>";
            } else {
                setTimeout(function () {
