<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\phpstudy_pro\WWW\www.tp5.com/application/admin\view\gather\gatherlist.html";i:1704959200;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-fluid">
            ...
            <div class="layui-card-body" style="padding: 15px;">
                ...
                <div class="layui-form-item" style="height: 900px">
                    ...
                    <div class="layui-inline" style="width: 600px;">
                        <label class="layui-form-label"> 列表标题标签</label>
                        
                        <div class="layui-input-block">
                            <input type="radio" name="type" value="h1" title="h1" checked="">
                            <input type="radio" name="type" value="h2" title="h2">
                            <input type="radio" name="type" value="h3" title="h3">
                            <input type="radio" name="type" value="h4" title="h4">
                            <input type="radio" name="type" value="h5" title="h5">
                            <input type="radio" name="type" value="h6" title="h6">
                          </div>
                    </div>
        ...
        <script>
            ...
            function onGather(){
                ...
                $.ajax({
                    url:'<?php echo url("gatherList"); ?>',
                    data:{type:type,title_class:title_class,content_class:content_class,link:link},
                    type:"post",
                    dataType:'json',
                    timeout: 80000,
                    async: true,
