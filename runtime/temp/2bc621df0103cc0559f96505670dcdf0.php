<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"E:\phpstudy_pro\WWW\www.tp5.com\public/../application/admin\view\gather\gatheradmin.html";i:1710394819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                  ...
                                  <div class="fixed-table-toolbar">
                                    <div class="bars pull-left">
                                      ...
                                      <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                          <a class="layui-btn" id="add" href='<?php echo url("saveGatherAdmin"); ?>'><i class="layui-icon">&#xe608;</i> 添加</a>
                                      </div>
                                      <?php endif; ?>
                                    </div>
                                    <form action="" method="get">
                                        ...
                                        <div class="pull-right search">
                                          <input class="form-control input-outline" type="text" name="title" value="<?php if($title): ?><?php echo $title; endif; ?>" placeholder="标题">
                                        </div>
                                    </form>
                                  </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover  dataTable" id="editable" aria-describedby="editable_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="链接">链接</th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="关键字">关键字</th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="创建时间">创建时间</th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="更新时间">更新时间</th>
                                      ...
                                      <tbody>
                                          <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                                              <tr class="gradeA odd" id="d<?php echo $v['id']; ?>">
                                                  ...
                                                  <td class=" "><?php echo $v['keywords']; ?></td>
                                                  ...
                                                  <td class="center " style="height:20px">
                                                      <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                                          <?php if(in_array((数据修改), is_array($viewMenu)?$viewMenu:explode(',',$viewMenu))): ?>
                                                              <a type="button" class="layui-btn" href="<?php echo url('saveGatherAdmin'); ?>?id=<?php echo $v['id']; ?>" title="修改" style="height: 24px;line-height: 24px;padding: 0px 8px;"><i class="layui-icon">&#xe642;</i></a>
      ...
      function buttonDel(id){
        layer.msg('您确定要删除吗？', {
            ...
            ,yes: function(index){
                layer.close(index);
                $.ajax({
                    url:'<?php echo url("delGatherAdmin"); ?>',
                    data:{id:id},
                    type:'POST',
                    dataType:'json',
