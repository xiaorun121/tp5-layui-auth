<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\phpstudy_pro\WWW\www.tp5.com/application/admin\view\gather\savegather.html";i:1700815358;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-fluid">
          <div class="layui-card">
            <div class="layui-card-body" style="padding: 15px;">
                <form class="layui-form" action="<?php echo url('saveGather'); ?>" method="post" data-type="ajax">
                <div class="layui-form-item" >

                   
                    <div class="layui-inline" id="title">
                        <label class="layui-form-label"> 标题</label>
                        <div class="layui-input-inline">
                            <input type="text" name="title" value="<?php echo $getInfo['title']; ?>" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline" id="content">
                        ...
                        <div class="layui-input-inline" >
                            <textarea id="container"  name="content" style="width: 1200px;"><?php echo $getInfo['content']; ?></textarea>
                        </div>
                    </div>
