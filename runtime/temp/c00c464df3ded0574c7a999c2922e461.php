<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpstudy_pro\WWW\www.tp5.com/application/admin\view\trace\tostatusonelist.html";i:1706237322;}*/ ?>
<!DOCTYPE html>
<html>
              ...
              <div class="example">
                ...
                <div class="bootstrap-table">
                  <div class="fixed-table-toolbar">
                    <form action="<?php echo url('toStatusOneList'); ?>" method="get">
...
function delImage(id,image){
    ...
    function onReset(){
      layer.load(2);
      location.href = "<?php echo url('toStatusOneList'); ?>";
    }
