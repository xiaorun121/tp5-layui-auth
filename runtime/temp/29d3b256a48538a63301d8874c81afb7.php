<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\phpstudy_pro\WWW\www.tp5.com/application/admin\view\trace\tracelist.html";i:1706924712;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="bootstrap-table">
                  <div class="fixed-table-toolbar">
                    <div class="bars pull-left">
                      ...
                      <?php if(in_array((数据新增), is_array($viewMenu)?$viewMenu:explode(',',$viewMenu))): ?>
                      <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                        <a class="layui-btn" id="add" href='<?php echo url("publicsavetrace"); ?>'><i
                            class="layui-icon">&#xe608;</i> 添加</a>
                      </div>
                      <?php endif; ?>
                    </div>
                    <form action="<?php echo url('traceList'); ?>" method="get">
...
<!--                       
                          ...
                          <div class="layui-input-block">
                              <div class="layui-inline" style="width: 100px;margin-top: 10px;">
                                  <select name="status" id="status" >
                                      <option value="0" aria-readonly="true" disabled="disabled" <?php if(!$status): ?>selected<?php endif; ?>>状态</option>
                                      <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>已上架</option>
                                      <option value="2" <?php if($status == 2): ?>selected<?php endif; ?>>审核中</option>
                                      <option value="3" <?php if($status == 3): ?>selected<?php endif; ?>>待审核</option>
                                      <option value="4" <?php if($status == 4): ?>selected<?php endif; ?>>账号禁用</option>
                                      <option value="5" <?php if($status == 5): ?>selected<?php endif; ?>>分配中</option>
                                      <option value="6" <?php if($status == 6): ?>selected<?php endif; ?>>已暂停</option>
                                      <option value="7" <?php if($status == 7): ?>selected<?php endif; ?>>待验证</option>
                                      <option value="8" <?php if($status == 8): ?>selected<?php endif; ?>>已下架</option>
                                      <option value="9" <?php if($status == 9): ?>selected<?php endif; ?>>账号关联</option>
                                      <option value="10" <?php if($status == 10): ?>selected<?php endif; ?>>更新中</option>
                                      <option value="11" <?php if($status == 11): ?>selected<?php endif; ?>>其他</option>
                                  </select>
                              </div>
                          </div>
                        </div>
                      ...
                      <div class="pull-right  layui-form" style="margin-top: 10px;width: 150px;margin-right: -25px;">
                        <div class="layui-inline" >
                          <div class="layui-input-block">
                              <div class="layui-inline" style="width: 120px;">
                                  <select name="b_project" id="b_project">
                                      ...
                                      <?php if(is_array($bProject) || $bProject instanceof \think\Collection || $bProject instanceof \think\Paginator): $i = 0; $__LIST__ = $bProject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                          <option value="<?php echo $v['b_project']; ?>" <?php if($b_project == $v['b_project']): ?>selected<?php endif; ?> ><?php echo $v['b_project']; ?></option>
                      ...
                      <div class="pull-left layui-form" style="margin-top: -30px;margin-left: 10px;width: 150px;">
                      ...
                      <table id="exampleTableLargeColumns" data-show-columns="true" data-height="400"
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th style="position: sticky;left: 236px;top: 0;z-index: 999999999;background: #f5f5f5;" data-field="应用名" tabindex="0">
                          ...
                          <tbody>
                              ...
                              <tr data-index="<?php echo $v['id']; ?>" id="d<?php echo $v['id']; ?>">
                                ...
                                <td class=" " title="<?php echo $v['app_name']; ?>" style="position: sticky;left: 236px;top: 0;z-index: 999999999;background: #f5f5f5;"><?php echo $v['app_name']; ?></td>
                                <td class="layui-form ">
  ...
  <script type="text/javascript">
    ...
    function onReset(){
      layer.load(2);
      location.href = "<?php echo url('traceList'); ?>";
    }
