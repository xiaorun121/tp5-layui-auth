<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\phpstudy_pro\WWW\www.tp5.com/application/admin\view\chat\chatlist.html";i:1702952446;}*/ ?>
<!DOCTYPE html>
<html>
                                ...
                                <div class="bootstrap-table">
                                    <div class="fixed-table-toolbar">
                                        <div class="bars pull-left">
                                            <?php if(in_array((讨论组新增), is_array($viewMenu)?$viewMenu:explode(',',$viewMenu))): ?>
                                            <div class="btn-group hidden-xs" id="exampleTableEventsToolbar"
                                                role="group">
                                                <a href="<?php echo url('publicsavechat'); ?>" class="layui-btn" id="add"><i
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc" tabindex="0" aria-controls="editable"
                                                        rowspan="1" colspan="1" aria-label="讨论组id">
                                                        讨论组id
                                                    </th>
                                                    <th class="sorting_asc" tabindex="0" aria-controls="editable"
                                                        rowspan="1" colspan="1" aria-label="备注">
                                                        备注
                                                    </th>

                                                    <th class="sorting_asc" tabindex="0" aria-controls="editable"
                                                        rowspan="1" colspan="1" aria-label="操作" width="15%">
                                                        操作
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php if(is_array($chat) || $chat instanceof \think\Collection || $chat instanceof \think\Paginator): $k = 0; $__LIST__ = $chat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                                                <tr class="gradeA odd" id="d<?php echo $v['id']; ?>">
                                                    <td class="sorting_1"><?php echo $v['id']; ?></td>
                                                    <td class=" "><?php echo $v['chat_id']; ?></td>
                                                    <td class=" "><?php echo $v['detail']; ?></td>
                                                    <td class="center" style="height: 20px">
                                                        <div class="btn-group hidden-xs" id="exampleTableEventsToolbar"
                                                            role="group">
                                                            <?php if(in_array((讨论组删除), is_array($viewMenu)?$viewMenu:explode(',',$viewMenu))): ?>
                                                            <button type="button" class="layui-btn layui-btn-danger"
                                                                onclick="buttonDel(<?php echo $v['id']; ?>);" title="删除" style="
                                                                    height: 24px;
                                                                    line-height: 24px;
                                                                    padding: 0px 8px;
                                                                ">
